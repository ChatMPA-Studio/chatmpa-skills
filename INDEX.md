...
**13 skills.** Classified along three axes — *domain* (research field), *data source*, and *output type*. A skill may appear under more than one heading.

**Lifecycle:** 🧪 experimental 1 · ✅ stable 12 · ⚠️ deprecated 0.
...
| Skill | Version | Status | Domain | Data source | Output | Tags |
|---|---|---|---|---|---|---|
